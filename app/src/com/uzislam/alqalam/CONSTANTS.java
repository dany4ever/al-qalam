...
public class CONSTANTS {
        ...
        public static final int[]   SURAH_NUMBER_OF_AYATS = new int[] {7,286,200,176,120,165,206,75,129,109,123,111,43,52,99,128,111,110,98,135,112,78,118,64,77,227,93,88,69,60,
         ...
         */
        public static final int[]   MADANI_SURAH_INDEX = new int[] {2,3,4,5,8,9,13,22,24,33,47,48,49,57,58,59,60,61,62,63,64,65,66,76,98,99,110,113,114};
    
        public static final int [][] SAJDA_INDEXES = new int [][]  { {7,206}, {13, 15}, {16, 50}, {17,109}, {19, 58}, {22, 18}, {25, 60}, {27, 26},
            {32, 15}, {38, 24}, {41,38}, {53, 62}, {84,21}, {96, 19} };
        
        public static final int [][]  JUZZ_INDEXES = new int [][] { {1, 1}, {2, 142}, {2, 253}, {3, 93}, {4, 24}, {4, 148}, {5, 82}, {6,111}, {7, 88}, {8, 41}, 
            {9, 93}, {11, 6}, {12, 53}, {15, 1}, {17, 1}, {18, 75}, {21, 1}, {23, 1}, {25, 21}, {27,56}, {29, 46}, {33, 31}, {36, 28}, {39, 32}, 
            {41, 47}, {46, 1}, {51, 31}, {58, 1}, {67, 1}, {78, 1} };
        
        public static final int[] TITLE_OF_SURAHS = {R.drawable.sname_1, R.drawable.sname_2, R.drawable.sname_3, R.drawable.sname_4, R.drawable.sname_5, R.drawable.sname_6,
        ...
        public static final String[]        RECITER_DIRECTORY =  {"shatri", "gamidi"};
        ...
        public static boolean[]         SURAH_IS_ARABIC_DOWNLOADED = new boolean [NUMBER_OF_SURAHS];
        public static boolean[]         SURAH_IS_AUDIO_DOWNLOADED = new boolean [NUMBER_OF_SURAHS];
